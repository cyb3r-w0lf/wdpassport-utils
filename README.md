...
I [cyb3r-w0lf](https://github.com/cyb3r-w0lf/wdpassport-utils), have made additional modifications to the original code to improve functionality and user experience.
...
Install py3_sg and pyudev via pip
```
sudo python3 -m pip install py3_sg pyudev
```
...
```
sudo pip install git+https://github.com/cyb3r-w0lf/wdpassport-utils
```
